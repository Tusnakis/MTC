    ...
    <div class="col-12 d-flex my-4">
        <form action="index.php?ruta=mostrarUsuariosFiltrados" method="POST">
            <div class="form-group row">
                <label for="inputUsuario" class=" col-12 col-sm-3 col-form-label">Usuario</label>
                ...
                <?php for ($i = 0; $i < count($params['resultado']); $i++) { ?>
                    <tr>
                        <form action="index.php?ruta=actualizarUsuarios" method="POST">
                            ...
                            <td><input type="password" name="contrasena" class="form-control text-center" value="<?php echo $params['resultado'][$i]['contrasena'] ?>" required></td>
